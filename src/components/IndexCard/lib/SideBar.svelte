<script context="module" lang="ts">
  ...
  strategies.set(EventType.IssuesEvent, (event) =>
    createUpdate(
      event,
  ...
  strategies.set(EventType.PullRequestEvent, (event) =>
    createUpdate(
      event,
...
<Squircle>
  ...
  <ul class="mt-2 grid sm:grid-cols-2 md:grid-cols-1 gap-3">
    ...
    {:else}
      <span class="text-gray-800 dark:text-gray-400"> Nothing new... yet </span>
    {/each}
  </ul>
</Squircle>
